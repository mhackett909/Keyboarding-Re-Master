...
@rem ##########################################################################
@rem
@rem  keyboarding-re-master startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and KEYBOARDING_RE_MASTER_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %KEYBOARDING_RE_MASTER_OPTS%  -classpath "%CLASSPATH%" com.monkygames.kbmaster.KeyboardingMaster %CMD_LINE_ARGS%
...
:fail
rem Set variable KEYBOARDING_RE_MASTER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%KEYBOARDING_RE_MASTER_EXIT_CONSOLE%" exit 1
exit /b 1
