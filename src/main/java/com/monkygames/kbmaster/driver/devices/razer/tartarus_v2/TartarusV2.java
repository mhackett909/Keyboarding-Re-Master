 ...
 */
package com.monkygames.kbmaster.driver.devices.razer.tartarus_v2;
...
// ============= Constructors ============== //
	...
	super("Razer","Tartarus V2","Razer Razer Tartarus V2", DeviceType.KEYBOARD,
		...
		"http://www.amazon.com/gp/product/B07754PYFK/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B07754PYFK&linkCode=as2&tag=monkygamescom-20",
		true);
