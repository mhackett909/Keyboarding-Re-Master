 ...
 */
package com.monkygames.kbmaster.driver.devices.razer.orbweaver;
...
// ============= Constructors ============== //
    public Orbweaver(){
	super("Razer","Orbweaver","Razer Razer Orbweaver", DeviceType.KEYBOARD,
		"/com/monkygames/kbmaster/driver/razer/orbweaver/resources/icon.png",
		// === Description === //
