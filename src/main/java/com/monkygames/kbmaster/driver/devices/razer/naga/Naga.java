 ...
 */
package com.monkygames.kbmaster.driver.devices.razer.naga;
...
// ============= Constructors ============== //
	...
	super("Razer","Naga","Razer Razer Naga", DeviceType.MOUSE,
		...
		"http://www.amazon.com/gp/product/B00E8CF268/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B00E8CF268&linkCode=as2&tag=monkygamescom-20",
		true);
    }
// ============= Public Methods ============== //
// ============= Protected Methods ============== //
