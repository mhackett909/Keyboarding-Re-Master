 ...
 */
package com.monkygames.kbmaster.driver.razer.tartaruschroma;
...
// ============= Constructors ============== //
    public TartarusChroma(){
	super("Razer","Tartarus Chroma","Razer Razer Tartarus Chroma", DeviceType.KEYBOARD,
		"/com/monkygames/kbmaster/driver/razer/tartaruschroma/resources/icon.png",
		// === Description === //
		...
		// === =========== === //
		"1.0",
		"com.monkygames.kbmaster.driver.razer.tartaruschroma.TartarusChroma",
